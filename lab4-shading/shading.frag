...
vec3 calculateDirectIllumiunation(vec3 wo, vec3 n, vec3 base_color)
{
    ...
    //            return vec3(0);
    ///////////////////////////////////////////////////////////////////////////
    float distance_to_light = length(viewSpaceLightPosition - viewSpacePosition);
    float falloff_factor = 1.0 / (distance_to_light * distance_to_light);
...
vec3 calculateIndirectIllumination(vec3 wo, vec3 n, vec3 base_color)
{
    ...
    ///////////////////////////////////////////////////////////////////////////
    vec3 w_normal = vec3(viewInverse * vec4(n, 0.0));
    float theta = acos(max(-1.0f, min(1.0f, w_normal.y)));
    float phi = atan(w_normal.z, w_normal.x);
    if (phi < 0.0f) {
        phi = phi + 2.0f * PI;
    }
